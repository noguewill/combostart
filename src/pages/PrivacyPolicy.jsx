      ...
      <div className={styles.tos_container}>
        ...
        <div className={styles[`${theme}tos_body_parent`]}>
          <p className={styles[`${theme}tos_body`]}>
            ...
            <br />
            <br />
            Welcome to Combostart! This Privacy Policy explains how we collect,
            use, store, and protect your personal information when you use our
            website. Please read this Privacy Policy carefully to understand our
            ...
            (location), the device you're using, and device details. This data
            ...
            <br />
            1. <strong>Analytics:</strong> We use analytics data to analyze user
            behavior, optimize our website's performance, and enhance user
            experience.
            <br />
            <br />
            ...
            to protect your personal information. However, please be aware that
            ...
            not be sold until we provide a notice to our users if there are any
            changes to this policy.
            <br />
            <br />
            <strong>Your Rights</strong>
            <br />
            You have full autonomy over your personal data. You can exercise the
            following rights:
            <br />
            1. <strong>Data Access and Deletion:</strong> You can request access
            to your personal data we have collected and stored. You also have
            the right to request the deletion of your data from our records.
            <br />
            <br />
