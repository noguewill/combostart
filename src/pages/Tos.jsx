...
const Tos = () => {
  ...
  return (
    <>
      <Helmet>
        <title>COMBOSTART | Terms of Service</title>

        <link rel="canonical" href="https://combostart.vercel.app/Tos" />
      </Helmet>
        ...
        <div className={styles.tos_container}>
          ...
          <div className={styles[`${theme}tos_body_parent`]}>
            <p className={styles[`${theme}tos_body`]}>
              ...
              and use of COMBOSTART website and services (collectively referred
              to as the &quot;Service&quot;). Please read these Terms carefully
              ...
              age requirement. If you are using the Service on behalf of an
              organization, you represent and warrant that you have the
              necessary authority to bind that organization to these Terms.
              <br />
              <br />
              ...
              <br />
              COMBOSTART and its licensors retain all rights, title, and
              interest in and to the Service, including all content, logos,
              trademarks, and other intellectual property. You may not use any
              trademarks, logos, or other proprietary information of COMBOSTART
              ...
              entity.
              <br />
              e. Interfering with or disrupting the Service, servers, or
              networks connected to the Service.
              <br />
              f. Engaging in any activity that could harm or negatively impact
              ...
              Termination
              <br />
              COMBOSTART reserves the right, at its sole discretion, to suspend
              or terminate your access to the Service, without prior notice or
              ...
              available&quot; basis. COMBOSTART does not warrant that the
              Service will be uninterrupted, error-free, or secure. COMBOSTART
              disclaims all warranties of any kind, whether express, implied, or
              statutory, regarding the Service.
              <br />
              <br />
              ...
              profits, data loss, or other intangible losses, arising out of or
              in connection with your use of the Service.
              <br />
              <br />
              Changes to the Terms
              <br />
              COMBOSTART reserves the right to modify or revise these Terms at
              any time, with or without notice. The updated Terms will be
              effective upon posting. Your continued use of the Service after
              ...
              the laws of Brazil. Any legal action or proceeding arising out of
              or relating to these Terms or the Service shall be exclusively
              brought in the courts located in Brazil, and you consent to the
              ...
              COMBOSTART regarding your use of the Service and supersede any
              ...
              User Conduct
              <br />
              You agree to use the Service in a responsible and lawful manner.
              You shall not engage in any activity that violates any applicable
              laws, regulations, or third-party rights. This includes but is not
              limited to harassment, spamming, or engaging in any activity that
              disrupts the user experience on the Service.
              <br />
              <br />
              ...
              available on or through any third-party websites or services.
              <br />
              <br />
              Indemnification
              <br />
              You agree to indemnify, defend, and hold harmless COMBOSTART and
              its creator against any claims, liabilities, damages, losses,
              costs, or expenses arising out of or in connection with your use
              ...
              <br />
              COMBOSTART reserves the right to modify, suspend, or discontinue
              the Service, or any part thereof,with prior notice. You agree that
              ...
              Waiver
              <br />
              The failure of COMBOSTART to enforce any right or provision of
              these Terms shall not constitute a waiver of such right or
              provision unless acknowledged and agreed to by COMBOSTART in
              writing.
              <br />
              <br />
              ...
              premium content is subject to additional terms and conditions,
              which will be clearly stated on the Service.
              <br />
              ...
              <br />
              d. COMBOSTART shall not be liable for any damages or losses
              incurred by users due to changes, limitations, or discontinuation
              of premium content, features, or services.
              <br />
              ...
              respective payment processors. COMBOSTART is not responsible for
              any issues or disputes arising from Patreon subscriptions or
              donations.
              <br />
